...
import com.fawaid_elbenaa.databinding.CatogryRow3Binding;
...
public class Category_Adapter3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Category_Adapter3(List<SingleCategoryModel> singleCategoryModelList, Context context, Fragment fragment) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@androidx.annotation.NonNull ViewGroup parent, int viewType) {
        ...
        CatogryRow3Binding binding = DataBindingUtil.inflate(inflater, R.layout.catogry_row3, parent, false);
    ...
    public void onBindViewHolder(@androidx.annotation.NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        eventHolder.itemView.setOnClickListener(v -> {
            if (fragment instanceof Fragment_Department) {
                ...
                fragment_department.setItemData(singleCategoryModelList.get(eventHolder.getLayoutPosition()));
...
if(i!=position) {
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        public CatogryRow3Binding binding;

        public EventHolder(@androidx.annotation.NonNull CatogryRow3Binding binding) {
